...
#if defined(CONFIG_ZLG_GPIO_WATCHDOG)
#define SW_MUX_CTL_REG 0x020e001c
#define MUX_MODE 0x5

#define SW_PAD_CTL_REG 0x020e02a8
#define PAD_CTL_CFG 0x17059

#define GPIO5_GDIR_REG 0x020ac004
#define WDT_GPIO_OFF 0x0
#define GPIO5_DR_REG 0x020ac000

STATIC void INIT watchdog_pin_init(void)
{
	*(volatile unsigned int *)SW_MUX_CTL_REG = MUX_MODE;
	*(volatile unsigned int *)SW_PAD_CTL_REG = PAD_CTL_CFG;
	*(volatile unsigned int *)GPIO5_GDIR_REG |= 1 << WDT_GPIO_OFF;
}

STATIC void watchdog_reset(void)
{
	unsigned int value = 0;
	value = *(volatile unsigned int *)GPIO5_DR_REG << 31;
	if ( value == 1 )
	    *(volatile unsigned int *)GPIO5_DR_REG &= 0xfffffffe;
	else
	    *(volatile unsigned int *)GPIO5_DR_REG |= 1 << WDT_GPIO_OFF;
